...
export default function LampDemo() {
  return (
    <LampContainer>
      <motion.h1
        initial={{ opacity: 0.5, y: -400 }}   // empieza más arriba
        whileInView={{ opacity: 1, y: -300 }} // baja un poco (posición final)
        transition={{
          delay: 0.3,
          duration: 0.8,
          ease: "easeInOut",
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        {/* Conic gradient izquierda */}
        <motion.div
          initial={{ opacity: 0.5, width: "15rem", y: -300 }}
          whileInView={{ opacity: 1, width: "30rem", y: -180 }}
        ...
        {/* Fondo y blur */}
        {/* <div className="absolute top-1/2 h-48 w-full translate-y-1 scale-x-150 bg-slate-950 blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div> */}
          

        {/* Glow azul principal */}
        <motion.div
          initial={{ opacity: 0.3, width: "10rem", y: -300 }}
          whileInView={{ opacity: 0.5, width: "28rem", y: -180 }} // -72px ≈ antes era -translate-y-1/2
          transition={{ delay: 0.4, duration: 0.8, ease: "easeInOut" }}
          className="absolute inset-auto z-50 h-36 rounded-full bg-cyan-500 blur-3xl"
        />

        {/* Glow azul redondo */}
        <motion.div
          initial={{ width: "8rem", y: -300 }}
          whileInView={{ width: "16rem", y: -180 }} // -96px ≈ antes era -translate-y-[6rem]
          transition={{ delay: 0.5, duration: 0.8, ease: "easeInOut" }}
          className="absolute inset-auto z-30 h-36 rounded-full bg-cyan-400 blur-2xl"
          />

        

        {/* Capa negra superior */}
        {/* <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[18rem] bg-slate-950 "></div> */}
      </div>
