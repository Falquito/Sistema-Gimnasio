...
export const LoaderThree = () => {
  return (
    <motion.svg
      ...
      className="h-20 w-20 stroke-black [--fill-final:var(--color-emerald-500)] dark:stroke-neutral-100 dark:[--fill-final:var(--color-yellow-500)] dark:[--fill-initial:var(--color-neutral-800)]"
    >
...
export const FullScreenLoader = ({ text = "Loading..." }: { text?: string }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black opacity-25">
      <LoaderThree />
    </div>
  );
};
export const LoaderFour = ({ text = "Loading..." }: { text?: string }) => {
  return (
    <div className="font-bold text-white [perspective:1000px] dark:text-white ">
      <motion.span
        animate={{
          skew: [0, -40, 0],
          scaleX: [1, 2, 1],
